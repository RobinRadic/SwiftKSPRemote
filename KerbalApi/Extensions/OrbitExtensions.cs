...
namespace KerbalApi
{
    public static class OrbitExtensions
    {
        ...
        public static Orbit PerturbedOrbit(this Orbit o, double UT, Vector3d dV)
        {
            ...
            return Utils.OrbitFromStateVectors(o.SwappedAbsolutePositionAtUT(UT), o.SwappedOrbitalVelocityAtUT(UT) + dV, o.referenceBody, UT);
        }
        ...
        public static double NextClosestApproachTime(this Orbit a, Orbit b, double UT)
        {
            ...
            for (int iter = 0; iter < 8; iter++)
            {
                ...
                minTime = Utils.Clamp(closestApproachTime - dt, UT, UT + interval);
                maxTime = Utils.Clamp(closestApproachTime + dt, UT, UT + interval);
            }
        ...
        public static double MeanAnomalyAtUT(this Orbit o, double UT)
        {
            ...
            if (o.eccentricity < 1) ret = Utils.ClampRadiansTwoPi(ret);
            return ret;
        }
        ...
        public static double UTAtMeanAnomaly(this Orbit o, double meanAnomaly, double UT)
        {
            ...
            if (o.eccentricity < 1) meanDifference = Utils.ClampRadiansTwoPi(meanDifference);
