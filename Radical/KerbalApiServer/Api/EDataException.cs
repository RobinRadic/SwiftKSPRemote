...
namespace Radical.KerbalApiServer.Api
{
  ...
  [Serializable]
  #endif
  public partial class EDataException : TException, TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("EDataException");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("EDataException(");
      bool __first = true;
      if (__isset.code) {
