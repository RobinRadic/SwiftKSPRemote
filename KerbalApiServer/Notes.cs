...
namespace Radical.KerbalApiServer.Kate
{
    ...
    public class Notes : MonoBehaviour
    {
        ...
        private void LoadSettings()
        {
            ...
            _notesDir = _configFile.GetValue("notesdir", KSPUtil.ApplicationRootPath.Replace("\\", "/") +
                                                        "GameData/SwiftKSPRemote/PluginData/SwiftKSPRemote/");
        ...
        {
            GameObject.Find("SKRImmortal").GetComponent<Addon>().compiler.RunCode(_text);
        }
    }
}